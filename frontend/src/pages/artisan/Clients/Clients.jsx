...
function ClientCard({ client }) {
  ...
  return (
    <div className="cc" onClick={go} role="button" tabIndex={0}
      onKeyDown={(e) => e.key === "Enter" && go()}
      aria-label={`View profile for ${client.name}`}
    >
      <div className="cc__overlay"><span className="cc__overlay-btn">View Profile</span></div>
      ...
      <div className="cc__footer">
        <span className="cc__footer-stat">
          ...
          {client.orderCount ?? 0} {(client.orderCount ?? 0) === 1 ? "order" : "orders"}
        </span>
        {client.lastOrderShort && client.lastOrderShort !== "—" && (
    ...
    <div className="clients-page">
      <div className="clients-page__toolbar">
        <div className="clients-page__search-wrap">
          ...
          <input className="clients-page__search" type="search" placeholder="Search Clients"
            value={search} onChange={(e) => setSearch(e.target.value)} />
        </div>
        <button className="clients-page__add-btn" type="button" onClick={() => navigate("/artisan/clients/add")}>
      ...
      {loadingClients && clients.length === 0 && (
        <div className="clients-page__empty"><p>Loading clients…</p></div>
      )}
      ...
      {!loadingClients && clients.length === 0 ? (
        ...
        <div className="clients-page__empty"><p>No clients match your search.</p></div>
      ) : (
